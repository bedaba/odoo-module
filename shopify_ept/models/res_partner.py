...
class ResPartner(models.Model):
    ...
    def create_shopify_pos_customer(self, order_response, instance):
        ...
        res_partner = self.search_partner_by_email_phone(email, phone)
    ...
    def search_partner_by_email_phone(self, email, phone, get_parent=True):
        ...
        if get_parent and res_partner and res_partner.parent_id:
